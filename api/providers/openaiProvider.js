...
export const generateWithOpenAI = async ({
  ...
  if (isImageGenerationRequest) {
    ...
    if (!imageData) {
      const error = new Error("OpenAI did not return generated image data.");
      error.provider = "openai";
      throw error;
    }

    return {
      reply: "OpenAI generated your image successfully.",
      generatedOutputs: [
        {
          title: "Generated Image",
          content:
            "Generated by OpenAI. Open the image to preview or download it.",
        },
      ],
      generatedImages: [
        {
